...
# ---------------------------------------------------------------------------
# When AqtaBio is invoked from a SHARP-aware clinician workspace, the
...
async def get_patient_local_risk(
    ...
    Reads the SHARP context (`ai.promptopinion/fhir-context` extension),
    fetches the Patient resource from the SHARP-propagated FHIR
...
async def self_test() -> dict:
    ...
    Use cases:
      - Pre-flight check before any live demo
