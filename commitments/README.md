...
3. Find the most recent commitment file (`commitments/YYYY-MM-DD.json`
   from 2026-05-21 onward, `YYYY-WWW.json` before that) *before* the
...
- Each commitment is generated by the live MCP at
  ...
  GitHub Action that runs on the 1st and 15th of each month at
  09:00 UTC.
